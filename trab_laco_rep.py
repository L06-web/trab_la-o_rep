...
Operação: """)
    ...
    if operacao == "1":
        # Se a operação for soma, inicializa o resultado como 0
        result = 0
        while True:
        ...
        # Se a operação for subtração, inicializa o resultado como None
        result = None
        while True:
            # Solicita um número ao usuário ou 'P' para parar
            n = input("Digite um número ou 'P' para parar: ")
            ...
            if result is None:
                ...
                # Caso contrário, subtrai o número do resultado
                result -= int(n)
        # Imprime o resultado da subtração
        print("Resultado da subtração:", result)
    elif operacao == "3":
        # Se a operação for multiplicação, inicializa o resultado como 1
        result = 1
        while True:
            # Solicita um número ao usuário ou 'P' para parar
            n = input("Digite um número ou 'P' para parar: ")
